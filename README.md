...
Feature Garden does not replace Clean Architecture, Ports & Adapters, or DDD. Instead, it complements them well. Read more about combining Feature Garden with these approaches in the [Engineering Guide](./docs/engineering-guide.md).
